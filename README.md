...
- [x] Add any third party library to your project to enhance it's functionality. Some ideas you might consider include **_(CHOOSE ONLY ONE)_**:
    ...
    - [x] **_FILL IN THE BLANK_**: `I will use the Blackfriday library. The documentation is located at https://pkg.go.dev/github.com/russross/blackfriday/v2#section-readme. My goal is to use it to parse txt files for any markdown and process it to html so that it can be injected into html templates.`
- [x] **Add, commit, and push to GitHub**.
